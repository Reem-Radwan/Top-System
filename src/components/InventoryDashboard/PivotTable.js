...
const PivotTable = ({ units }) => {
  ...
  const toggleColumnDropdown = () => {
    ...
    setShowRowDropdown(false); // Close row dropdown
  };

  // Toggle row dropdown visibility
  const toggleRowDropdown = () => {
    setShowRowDropdown(prev => !prev);
    setShowColumnDropdown(false); // Close column dropdown
  };
        ...
        <table className="pivot-table">
          ...
          <tbody>
            {visibleRows.cities && pivotData.map(city => {
              ...
              const isCityExpanded = expandedCities[city.name] !== false; // Default true
              ...
              return (
                <React.Fragment key={city.name}>
                  ...
                  {visibleRows.projects && isCityExpanded && Object.values(city.projects).map(project => {
                    ...
                    const isProjectExpanded = expandedProjects[projectKey]; // Default FALSE - don't show content
