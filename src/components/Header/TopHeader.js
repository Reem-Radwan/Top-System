  ...
  const menus = useMemo(
    () => [
      ...
      { label: "Projects", items: [{ label: "Manage Projects", to: "/manage-projects" }, { label: "MasterPlan Settings", to: "/masterplans-settings" },
        { label: "Payments Input", to: "/dual-payments" } , { label: "Special Offer Input", to: "/special-offer-input" }, { label: "Max Discount variables", to: "/variable-discount-rate" } , { label: "Web Configurations", to: "/web-configurations" }
      ] },
      { label: "Inventory", items: [{ label: "Inventory Hub", to: "/inventory-hub" },{ label: "Manage Inventory", to: "/manage-inventory" }, { label: "Unit Brochure", to: "/unit-brochure-manager" },{ label: "Contraction", to: "/contraction" },{ label: "Cancellation", to: "/cancellation" }] },
      ...
      { label: "Market Research", items: [{ label: "Master Data", to: "/master-data" }, { label: "Units Data", to: "/units-data" } , { label: "Team Performance", to: "/team-performance" }, { label: "Manager Analysis", to: "/manager-analysis" },{ label: "Market Explorer", to: "/market-explorer" } ,{ label: "Market Map View", to: "/market-map-view" },{ label: "Company Map View", to: "/company-map" },{ label: "Manage Project Map Data", to: "/manage-project-map-data" }] },
      // { label: "Pricing", items: [{ label: "Pricing Model", to: "/pricing-model" }] },
      { label: "Users & Companies", items: [{ label: "Manage Users", to: "/manage-users" },{ label: "Manage Companies", to: "/manage-companies" }, { label: "Attendance Sheet", to: "/attendance-sheet" } ,{ label: "Goole Sheets", to: "/google-sheets" } ,{ label: "Database", to: "/database" } ,{ label: "User Traffic Analysis", to: "/user-traffic-analysis" }
      ] },
    ],
    []
  );
