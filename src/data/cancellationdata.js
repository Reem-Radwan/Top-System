...
// cancellationdata.js
//
// Mock data for the Cancellation page.
// Synced with catalogedata.js — any cancelled unit is reflected back to the
// catalog in real-time via the cancellationBridge event emitter.
//
// SYNC CONTRACT:
//   • When a cancellation is confirmed, the unit's status becomes
//     "Blocked Cancellation", reservation_date & contract_payment_plan
//     are cleared, and sales_value resets to interest_free_unit_price.
//   • The cancellationBridge.emit() call fires a custom DOM event
//     ("cancellationUpdate") that the Catalog component listens for
//     and applies immediately — no page reload required.
// ─────────────────────────────────────────────────────────────────────────────
