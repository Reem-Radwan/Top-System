// ─────────────────────────────────────────────────────────────────────────────
// masterplansBridge.js
//
// Shared singleton that lives OUTSIDE both masterplansdata and
// masterplanssettingsdata so neither imports the other (no circular deps).
//
// masterplanssettingsdata  →  writes here  (pushes pin adds/deletes)
// masterplansdata          →  reads here   (live positions)
// masterplans.js           →  subscribes   (re-renders on change)
// ─────────────────────────────────────────────────────────────────────────────
