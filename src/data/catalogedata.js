...
// ─────────────────────────────────────────────────────────────────────────────
// catalogedata.js  –  fully synced with masterplansdata.js
//
// SYNC RULES:
//   • layout_images  → same arrays as masterplansdata brochureImages
//   • project_id     → same project ids as masterplansdata (101/201/301)
//   • map_focus_code → exact unit_code as it appears in masterplansdata
//                      unitPositions (so the pin can glow on the map)
//   • If a unit has NO pin in masterplansdata → project_id: null, map_focus_code: null
//   • If a unit has NO layout_images        → layout_images: []
// ─────────────────────────────────────────────────────────────────────────────
