...
// // Import catalogue units to validate codes against DB
// import { mockUnits } from '../data/catalogedata';
...
//   // Already initialised
//   if (positionStore[id] !== undefined) return;
...
//       if (!d.has_masterplan) { positionStore[id] = []; return; }

//       // Deep-clone so mutations don't corrupt the original masterplansdata
//       const positions = JSON.parse(JSON.stringify(d.unit_positions));

//       // Assign child_ids to every unit inside a building pin
...
// /**
//  * Check if a unit code exists in the catalogue (mockUnits).
//  */
// function isUnitInCatalogue(unitCode) {
//   return mockUnits.some(u => u.unit_code === unitCode);
// }
