...
// import './cataloge.css';
// import { mockUnits, mockCompanies } from './catalogedata';
...
//     { key: 'sellable_area', label: 'Gross Area (m²)', type: 'range' },
...
//     { key: 'interest_free_unit_price', label: 'Price (EGP)', isPrice: true },
//   ];
...
//     if (!selectedCompany || activeData.length === 0) return [];
...
//       })
//     );
//   }, [activeData, selectedCompany, allColumns]);
...
//         if (key === colKey || key === 'areaMin' || key === 'areaMax') continue;
...
//       for (const [key, selectedVals] of Object.entries(filters)) {
//         if (key === 'areaMin' || key === 'areaMax') continue;
//         if (selectedVals && selectedVals.length > 0) {
...
//                       (col.type === 'range' && (filters.areaMin || filters.areaMax));
...
//                                       onChange={(e) =>
//                                         handleRangeChange('areaMin', e.target.value)
//                                       }
//                                     />
//                                     <input
//                                       type="number"
...
//                                       onChange={(e) =>
//                                         handleRangeChange('areaMax', e.target.value)
//                                       }
//                                     />
//                                   </div>
//                                 </div>
