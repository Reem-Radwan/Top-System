...
// import { COMPANIES } from "../data/fakeManageUsersData";
...
//   // Prometheus extra block only for Business Team / Developer (NO Job Title anymore)
//   const showPrometheusBlock =
//     isPrometheusMode && (form.role === "Business Team" || form.role === "Developer");
...
//     if (pass && confirm && pass !== confirm) errors.push("Confirm Password must match Password.");
...
//     if (isCompanyUser && csvUI.open && !csvUI.file) {
...
//                 <i className="fas fa-envelope cu-lefticon" aria-hidden="true"></i>
//                 <input
//                   id="cu-email"
...
//                 >
//                   <i className={showPwd ? "fas fa-eye-slash" : "fas fa-eye"} aria-hidden="true"></i>
//                 </button>
//               </div>
//             </label>
...
//                 >
//                   <i
//                     className={showConfirmPwd ? "fas fa-eye-slash" : "fas fa-eye"}
//                     aria-hidden="true"
//                   ></i>
//                 </button>
//               </div>
...
//                   Company
//                   <div className="cu-inputwrap">
//                     <i className="fas fa-city cu-lefticon" aria-hidden="true"></i>
//                     <select
//                       className="mu-field cu-input"
...
//                       onClick={() =>
//                         setCsvUI((p) => ({ ...p, open: !p.open, file: !p.open ? p.file : null }))
//                       }
//                       aria-label="CSV import"
//                       title="CSV Import"
//                     >
//                       <i className="fas fa-file-csv"></i>
//                       <span className="cu-csv-btn-text">{csvUI.open ? "Hide CSV" : "CSV Import"}</span>
//                     </button>
...
//                           accept=".csv"
//                           onChange={(e) =>
//                             setCsvUI((p) => ({ ...p, file: e.target.files?.[0] || null }))
//                           }
//                         />
...
//                       </div>
//                     ) : (
//                       <div className="cu-csv-hint">Optional: import Company Users from CSV.</div>
//                     )}
//                   </div>
//                 ) : null}
//               </div>
...
//                   Joining Date
//                   <div className="cu-inputwrap">
//                     <i className="fas fa-calendar-alt cu-lefticon" aria-hidden="true"></i>
//                     <input
//                       className="mu-field cu-input"
//                       type="date"
...
//               Role
//               <div className="cu-inputwrap">
//                 <i className="fas fa-user-tag cu-lefticon" aria-hidden="true"></i>
//                 <select className="mu-field cu-input" value={form.role} onChange={(e) => onRoleChange(e.target.value)}>
...
//               {isCompanyMode ? (
//                 <div className="mu-hint">Company-based roles require selecting a Company.</div>
//               ) : (
//                 <div className="mu-hint">Prometheus roles are system roles (Admin/Business Team/Developer).</div>
//               )}
//             </label>
...
//                 <i className="fas fa-user-plus" style={{ marginRight: 6 }}></i> Create User
//               </button>
//             </div>
//           </form>
//         </div>
                ...
                {isCompanyUser ? (
                  <>
                    <div className="cu-perms">
                      <label className="cu-check">
                        <input
                          ...
                          onChange={(e) => update({ can_edit: e.target.checked })}
                        />
                      ...
                      <label className="cu-check">
                        <input
                          ...
                          onChange={(e) => update({ can_change_years: e.target.checked })}
                        />
                    ...
                    {showCsvImport ? (
                      ...
                      <div className="cu-csv-hint">Select a company to enable CSV import.</div>
                    )}
                  </>
                ) : null}
              </div>
            ...
            <label className="mu-label">
              ...
              {isCompanyMode ? (
                ...
                <div className="mu-hint">
                  Prometheus roles are system roles (Admin/Business Team/Developer).
                </div>
              )}
            </label>
